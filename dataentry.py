...
def lists ():
	...
	a1="active"
	return render_template('de_index.html',a1=a1,vendors=vendors_l,t=title,h=heading)
...
def tasks ():
	...
	a2="active"
	return render_template('de_index.html',a2=a2,vendors=vendors_l,t=title,h=heading)
...
def completed ():
	...
	a3="active"
	return render_template('de_index.html',a3=a3,vendors=vendors_l,t=title,h=heading)
...
@app.route("/action2")
def about2():
	return render_template('de_add.html',t=title,h=heading)
...
def update ():
	id=request.values.get("_id")
	task=vendors.find({"_id":ObjectId(id)})
	return render_template('de_update.html',tasks=task,h=heading,t=title)
...
def search():
	...
	return render_template('de_searchlist.html',vendors=vendors_l,t=title,h=heading)
